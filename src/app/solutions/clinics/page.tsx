...
export const metadata = {
  title: "Multi-Specialty Clinics Solution | MediFlow LIS",
  description: "Diagnostic reporting and baseline comparison platform for medical centers and multi-specialty clinics.",
  alternates: {
    canonical: "https://mediflow-saas.com/solutions/clinics",
  },
};
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-16">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="pt-4">
            ...
            >
              <span>Explore Clinic Portal</span>
