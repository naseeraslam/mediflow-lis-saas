...
import { ShieldCheck, Lock, Award, Dna, Sparkles, Microscope, FlaskConical, Search, CheckCircle2, ArrowRight, HeartPulse } from "lucide-react";

export function PublicFooter() {
  return (
    <footer className="bg-slate-950 border-t border-slate-800/80 text-slate-400 text-xs relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                <span className="text-2xl font-black text-white tracking-tight flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-teal-500/10 text-teal-300 border border-teal-500/30 font-extrabold uppercase tracking-wider">
                    SaaS
                  </span>
                </span>
            ...
            <p className="text-slate-400 leading-relaxed text-xs max-w-md font-medium">
            ...
            <div className="p-4 rounded-2xl bg-slate-900/90 border border-teal-500/30 space-y-2 backdrop-blur-xl shadow-xl">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 rounded-full bg-teal-500/20 text-teal-200 font-mono text-[9px] font-bold border border-teal-400/30">
                  ISO 15189 LEAD
                </span>
              </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <Link href="/app/super-admin" className="hover:text-teal-400 transition-colors text-slate-300">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-xs font-mono">
            ...
            <span className="text-slate-200 font-bold">100% OPERATIONAL:</span>
          ...
          >
            ...
            <span>Search Patient Reports Online</span>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          <p>© {new Date().getFullYear()} MediFlow Medical LIS SaaS Platform. Architectural Vision by <strong className="text-slate-300 font-bold">Sher Muhammad</strong>.</p>
